                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form id ="frmLogin">
                                            ...
                                            <div class="form-group">
                                                <label class="small mb-1" for="clave" name="clave"><i class="fas fa-key"></i> Contraseña</label>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; <a href="https://www.google.com/" target="_blank" rel="noopener noreferrer">Visite mi pagina web</a> <?php echo date("Y"); ?></div>
                            <div>
